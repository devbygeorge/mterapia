      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        <div className="rounded-2xl ring-1 ring-slate-200 bg-white p-5 sm:p-6">
          ...
          <ul className="mt-3 text-[0.875rem] text-slate-600  list-disc pl-5 space-y-1.5">
            <li>
              გაუქმებისა ან გადატანის შემთხვევაში საჭიროა 24 საათით ადრე
              გაფრთხილება.
            </li>
            <li>
              გთხოვთ, მობრძანდეთ 5 წუთით ადრე, რათა მაქსიმალურად გამოიყენოთ
              სეანსის დრო.
            </li>
            <li>გადახდა სეანსის დასრულებისას.</li>
          </ul>
        </div>
      </div>
    </section>
